...
rightBackMotor = new WPI_TalonFX(3);
    ...
    public void resetEncoders() {
        ...
        //leftFrontMotor.setSelectedSensorPosition(0, 0, kTimeoutMs);
		//rightFrontMotor.setSelectedSensorPosition(0, 0, kTimeoutMs);
		//leftFrontMotor.setSelectedSensorPosition(0, 1, kTimeoutMs);
		//rightFrontMotor.setSelectedSensorPosition(0, 1, kTimeoutMs);
    }
    ...
    //zeroSensors method is used in intialize method above
