...
rightBackMotor = new WPI_TalonFX(3);
	...
	m_leftMotors = new MotorControllerGroup(leftFrontMotor, leftMidMotor, leftBackMotor);
	m_rightMotors = new MotorControllerGroup(rightFrontMotor, rightMidMotor, rightBackMotor);
