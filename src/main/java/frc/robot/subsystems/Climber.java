...
rightTeleMotor = new WPI_TalonSRX(2);
	...
	public boolean isTeleAtDestination(){
		SmartDashboard.putNumber("Error",Math.abs(getLeftTeleEncoder() - m_distance));
	...
	public boolean checkBottomLimitSwitch() {
    	if (leftTeleMotor.getSensorCollection().isRevLimitSwitchClosed()|| rightTeleMotor.getSensorCollection().isRevLimitSwitchClosed()) {
    		resetPosBottom();
    		return true;
    	}
    	return false;
