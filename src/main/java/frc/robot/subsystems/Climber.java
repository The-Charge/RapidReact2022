...
rightTeleMotor = new WPI_TalonFX(6);
	...
	public boolean pastLimitSwitch(){
		return leftTeleMotor.getSensorCollection().isRevLimitSwitchClosed() == 1 && rightTeleMotor.getSensorCollection().isRevLimitSwitchClosed() == 1;
	}

	public boolean pastLimitSwitchLeftTele(){
		return leftTeleMotor.getSensorCollection().isRevLimitSwitchClosed() == 1;
	}

	public boolean pastLimitSwitchRightTele(){
		return rightTeleMotor.getSensorCollection().isRevLimitSwitchClosed()  == 1;
	}
