...
public class Pivot extends SubsystemBase {
	...
	private static final double MAX_GRAVITY_FF = 0.1;
	...
	private static final double SAFETY_TICKS_FWD = 5000;
	private static final double SAFETY_TICKS_REV = -3000;
	...
	*/
	...
	public void initializeMotors() {
		...
		rightPivotMotor.setNeutralMode(NeutralMode.Brake);
		 ...
		 leftPivotMotor.configForwardSoftLimitThreshold(SAFETY_TICKS_FWD);
		 rightPivotMotor.configForwardSoftLimitThreshold(SAFETY_TICKS_FWD);
		leftPivotMotor.configReverseSoftLimitThreshold(SAFETY_TICKS_REV);
		rightPivotMotor.configReverseSoftLimitThreshold(SAFETY_TICKS_REV);

		leftPivotMotor.configForwardSoftLimitEnable(true);
		rightPivotMotor.configForwardSoftLimitEnable(true);
		leftPivotMotor.configReverseSoftLimitEnable(true);
		rightPivotMotor.configReverseSoftLimitEnable(true);
	}
	...
	public void runDefaultMM(double angle) {
		...
		SmartDashboard.putNumber("Pivot output", leftPivotMotor.getMotorOutputVoltage());
