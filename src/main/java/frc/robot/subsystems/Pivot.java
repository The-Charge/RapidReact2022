...
private DigitalInput retroreflectiveSensor;
...
retroreflectiveSensor = new DigitalInput(9);
 addChild("RetroreflectiveSensor", retroreflectiveSensor);
	...
	public boolean checkPivotMaxReach(){
		return retroreflectiveSensor.get();
	}
}
