...
// The robot's subsystems
    // public final Indexer m_indexer = new Indexer(m_stopper);
    // public final Stopper m_stopper = new Stopper();
    // public final RetroReflectiveSensor m_retroReflectiveSensor = new RetroReflectiveSensor(m_drivetrain);
...
// Create some buttons
final JoystickButton toggleLockBtn = new JoystickButton(leftJoystick, 2);        
