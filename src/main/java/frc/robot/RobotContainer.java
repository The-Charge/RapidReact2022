...
// Create some buttons
final JoystickButton extendTeleBtn = new JoystickButton(rightJoystick, 5);        
extendTeleBtn.whenPressed(new TelescopeClimber(2.3, m_climber) ,true);
    SmartDashboard.putData("ExtendTeleBtn",new TelescopeClimber(3, m_climber) );

final JoystickButton resetTeleBtn = new JoystickButton(rightJoystick, 4);        
...
retractTeleBtn.whenPressed(new TelescopeClimber(.2, m_climber) ,true);
