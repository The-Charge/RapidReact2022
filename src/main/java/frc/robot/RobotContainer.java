...
private final Joystick leftJoystick = new Joystick(0);
  ...
  */
  private RobotContainer() {
    ...
    //SmartDashboard.putData("Drive x Feet", new DrivexFeet( m_drivetrain ));
...
// Create some buttons
final JoystickButton drivexfeet = new JoystickButton(rightJoystick, 4);        
drivexfeet.whenPressed(new DrivexFeet(4, m_drivetrain) ,true);
    SmartDashboard.putData("drivexfeet",new DrivexFeet(4, m_drivetrain) );
