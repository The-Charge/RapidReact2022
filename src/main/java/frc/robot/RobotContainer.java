...
// Create some buttons
final JoystickButton shifterLow = new JoystickButton(leftJoystick, 6);        
shifterLow.whenPressed(new ShiftLow( m_shifters ) ,true);
    SmartDashboard.putData("ShifterLow",new ShiftLow( m_shifters ) );

final JoystickButton shifterHigh = new JoystickButton(leftJoystick, 4);        
shifterHigh.whenPressed(new ShiftHigh( m_shifters ) ,true);
    SmartDashboard.putData("ShifterHigh",new ShiftHigh( m_shifters ) );
