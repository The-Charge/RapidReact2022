...
private final Joystick leftJoystick = new Joystick(0);
   ...
   // m_chooser.addOption("Auto Climb", new AutoClimb(m_drivetrain, m_arm));
   // m_chooser.setDefaultOption("Autonomous Command", new AutonomousCommand());
    m_chooser.setDefaultOption("test Tele", new SequentialCommandGroup(
                                                new ManualTele(0.8, false, m_telescope),
                                                new ManualTele(-0.8, false, m_telescope)
                                                )
                                );
    ...
    private void configureButtonBindings() {
        ...
        climbBtn.whenPressed(new ManualTele(-0.8, true, m_telescope) ,true);
    SmartDashboard.putData("pivotArmBackwardBtn",new ManualTele(-0.8, true, m_telescope));
