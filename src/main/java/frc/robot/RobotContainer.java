...
deliverCargoBtn.whileHeld(new DeliverCargo(0.3, m_arm) ,true);
    SmartDashboard.putData("DeliverCargoBtn",new DeliverCargo(0.3, m_arm) );

final JoystickButton intakeCargoBtn = new JoystickButton(rightJoystick, 5);        
intakeCargoBtn.whileHeld(new IntakeCargo(0.3, m_arm) ,true);
    SmartDashboard.putData("IntakeCargoBtn",new IntakeCargo(0.3, m_arm) );
