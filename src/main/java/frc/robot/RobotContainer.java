...
private final Joystick leftJoystick = new Joystick(0);
    ...
    SmartDashboard.putData("stopClimberBtn",new StopClimb( m_drivetrain, m_climber ) );
        ...
        final JoystickButton AutoClimbBtn = new JoystickButton(rightJoystick, 10);        
    AutoClimbBtn.whenPressed(new AutoClimb( m_drivetrain, m_climber ) ,true);
    SmartDashboard.putData("stopClimberBtn",new AutoClimb( m_drivetrain, m_climber ) );
