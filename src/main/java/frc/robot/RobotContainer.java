...
private final Joystick leftJoystick = new Joystick(0);
    ...
    SmartDashboard.putData("TempCheckRetro", new TempCheckRetro( m_pivot ));
...
// Create some buttons
final JoystickButton pivotArmBackwardBtn = new JoystickButton(buttonBox, 9);        
pivotArmBackwardBtn.whileHeld(new ManualPivot(0, m_pivot) ,true);
    SmartDashboard.putData("pivotArmBackwardBtn",new ManualPivot(0, m_pivot) );

final JoystickButton pivotArmForwardBtn = new JoystickButton(buttonBox, 8);        
pivotArmForwardBtn.whileHeld(new ManualPivot(0, m_pivot) ,true);
    SmartDashboard.putData("pivotArmForwardBtn",new ManualPivot(0, m_pivot) );

final JoystickButton teleArmDownBtn = new JoystickButton(buttonBox, 7);        
...
final JoystickButton intakeBtn = new JoystickButton(buttonBox, 4);        
intakeBtn.whileHeld(new IntakeCargo(0, m_arm) ,true);
    SmartDashboard.putData("intakeBtn",new IntakeCargo(0, m_arm) );

final JoystickButton lowerBtn = new JoystickButton(buttonBox, 3);        
lowerBtn.whenPressed(new LowerArm( m_arm ) ,true);
    SmartDashboard.putData("lowerBtn",new LowerArm( m_arm ) );

final JoystickButton deliverBtn = new JoystickButton(buttonBox, 2);        
deliverBtn.whileHeld(new DeliverCargo(0, m_arm) ,true);
    SmartDashboard.putData("deliverBtn",new DeliverCargo(0, m_arm) );

final JoystickButton liftBtn = new JoystickButton(buttonBox, 1);        
...
highGearBtn.whenPressed(new ShiftLow( m_shifters ) ,true);
    SmartDashboard.putData("highGearBtn",new ShiftLow( m_shifters ) );
...
final JoystickButton retroTester = new JoystickButton(leftJoystick, 2);        
retroTester.toggleWhenPressed(new TempCheckRetro( m_pivot ) ,true);
    SmartDashboard.putData("RetroTester",new TempCheckRetro( m_pivot ) );
