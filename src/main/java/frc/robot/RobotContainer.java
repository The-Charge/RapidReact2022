...
// Create some buttons
<<<<<<< HEAD
final JoystickButton teleRetractBtn = new JoystickButton(rightJoystick, 4);        
teleRetractBtn.whenPressed(new Telescope(0, m_climber) ,true);
    SmartDashboard.putData("teleRetractBtn",new Telescope(0, m_climber) );

final JoystickButton teleExtendBtn = new JoystickButton(rightJoystick, 3);        
teleExtendBtn.whenPressed(new Telescope(2, m_climber) ,true);
    SmartDashboard.putData("teleExtendBtn",new Telescope(2, m_climber) );
=======
...
>>>>>>> 81f1d6e38f903c49191e844b85185679d453179f
