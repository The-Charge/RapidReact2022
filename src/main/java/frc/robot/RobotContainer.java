...
private final Joystick leftJoystick = new Joystick(0);
    ...
    SmartDashboard.putData("PathWeaverTest", new PathWeaverTest( m_drivetrain ));
    SmartDashboard.putData("DriveBySpeed", new DriveBySpeed( m_drivetrain ));
    ...
    m_chooser.addOption("PathWeaverTest", new PathWeaverTest( m_drivetrain ));
    m_chooser.addOption("DriveBySpeed", new DriveBySpeed( m_drivetrain ));
    m_chooser.setDefaultOption("Autonomous Command", new AutonomousForward(m_drivetrain));
