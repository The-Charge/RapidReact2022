...
// The robot's subsystems
    public final ColorSensor m_colorSensor = new ColorSensor(null, 0);
    public final Arm m_arm = new Arm();
    public final Climber m_climber = new Climber();
    public final Shifters m_shifters = new Shifters();
    public final Drivetrain m_drivetrain = new Drivetrain();
    public final Aligner m_aligner = new Aligner(m_drivetrain);
...
private final Joystick leftJoystick = new Joystick(0);
    ...
    SmartDashboard.putData("ColorAlign", new ColorAlign( m_aligner));
