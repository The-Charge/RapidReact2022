...
private final Joystick leftJoystick = new Joystick(0);
    ...
    SmartDashboard.putData("DriveXFeet", new DriveXFeet(2, m_drivetrain));
    ...
    private void configureButtonBindings() {
        ...
        climbBtn.whenPressed(new SequentialCommandGroup(
...
teleArmDownBtn.whenPressed(new TelescopeClimber(250, m_telescope) ,true);
