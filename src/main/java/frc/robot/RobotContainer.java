...
private final Joystick leftJoystick = new Joystick(0);
    ...
    SmartDashboard.putData("IntakeCargo", new IntakeCargo( m_arm ));
    SmartDashboard.putData("DeliverCargo", new DeliverCargo( m_arm ));
...
// Create some buttons
final JoystickButton deliverCargoBtn = new JoystickButton(rightJoystick, 6);        
deliverCargoBtn.whileHeld(new DeliverCargo( m_arm ) ,true);
    SmartDashboard.putData("DeliverCargoBtn",new DeliverCargo( m_arm ) );

final JoystickButton intakeCargoBtn = new JoystickButton(rightJoystick, 5);        
intakeCargoBtn.whileHeld(new IntakeCargo( m_arm ) ,true);
    SmartDashboard.putData("IntakeCargoBtn",new IntakeCargo( m_arm ) );
...
final JoystickButton lowerArmBtn = new JoystickButton(leftJoystick, 5);        
lowerArmBtn.whenPressed(new LowerArm( m_arm ) ,true);
    SmartDashboard.putData("LowerArmBtn",new LowerArm( m_arm ) );

final JoystickButton liftArmBtn = new JoystickButton(leftJoystick, 4);        
liftArmBtn.whenPressed(new LiftArm( m_arm ) ,true);
    SmartDashboard.putData("LiftArmBtn",new LiftArm( m_arm ) );
