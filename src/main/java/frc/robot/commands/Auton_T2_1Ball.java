 ...
 *
 */
public class Auton_T2_1Ball extends SequentialCommandGroup {
    ...
    public Auton_T2_1Ball(Drivetrain drivetrain, Arm arm){
    ...
    addCommands(
        ...
        new SequentialCommandGroup(
            new WaitCommand(3),
            factory.lowerAndIntake(4, AutoConstants.intakeSpeed, arm),
            new LiftArm(arm),
            new WaitCommand(4),
            factory.deliver(2, AutoConstants.deliverSpeed, arm))
        )
        //getAutonomous2()
        );
    }
    ...
    public Command getAutonomous1() {
        try {
            ...
            String trajectoryJSON = "output/T2_Backup.wpilib.json";
            Path trajectoryPath = Filesystem.getDeployDirectory().toPath().resolve(trajectoryJSON);
            Trajectory exampleTrajectory = TrajectoryUtil.fromPathweaverJson(trajectoryPath);

            trajectoryJSON = "output/T2_Grab1.wpilib.json";
    ...
    public Command getAutonomous2() {
        try {
            ...
            String trajectoryJSON = "output/T2_Grab1.wpilib.json";
            Path trajectoryPath = Filesystem.getDeployDirectory().toPath().resolve(trajectoryJSON);
            Trajectory exampleTrajectory = TrajectoryUtil.fromPathweaverJson(trajectoryPath);
