...
public class Auton_T2_Delay extends SequentialCommandGroup {
    ...
    public Command getAutonomous1() {
        try {
            ...
            trajectoryJSON = "output/T2_Score1.wpilib.json";
            ...
            trajectoryJSON = "output/T2_GetOut.wpilib.json";
            Path trajectoryPath2 = Filesystem.getDeployDirectory().toPath().resolve(trajectoryJSON);
            Trajectory exampleTrajectory2 = TrajectoryUtil.fromPathweaverJson(trajectoryPath2);

            traj = traj.concatenate(exampleTrajectory2);
